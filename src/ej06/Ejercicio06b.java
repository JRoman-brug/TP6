...
public class Ejercicio06b {
	...
	public static <E> void eliminarHijoeExtremoN(Tree<E> A) {
		try {
			extremoIzquierdoRec(A.root(),A);
		}catch(EmptyTreeException e) {
			e.printStackTrace();
		}
	}
	private static <E> void extremoIzquierdoRec(Position<E> nodo, Tree<E> A) {
		try {
